...
#    essential_auditor.rights << settings_read
    #premium_owner	
#    premium_owner.rights << settings_    # enterprise_employee.rights << users_read
    # enterprise_employee.rights << users_update
#read
...
#    folders_update = Right.create!(:resource => 'folders', :operation => 'UPDATE')
     ...
     free_owner.rights << folders_create
     free_owner.rights << folders_read
     free_owner.rights << folders_update
     free_owner.rights << folders_delete
   #premium_owner	
...
#    myfiles_update = Right.create!(:resource => 'myfiles', :operation => 'UPDATE')
     ...
     free_owner.rights << myfiles_create
     free_owner.rights << myfiles_read
     free_owner.rights << myfiles_update
     free_owner.rights << myfiles_delete
...
# Support
    ...
    free_owner.rights << supports_create
    free_owner.rights << supports_read
    free_owner.rights << supports_update
    free_owner.rights << supports_delete
...
# Feedback
    ...
    free_owner.rights << feedbacks_create
    free_owner.rights << feedbacks_read
    free_owner.rights << feedbacks_update
    free_owner.rights << feedbacks_delete

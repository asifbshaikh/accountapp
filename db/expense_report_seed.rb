ActiveRecord::Base.transaction do
	...
	expense_report_read=Right.create!(:resource=>"credit_expense_reports", :operation=>"READ")

  # professional_owner  
  professional_owner.rights << expense_report_read
  # professional_accountant
  professional_accountant.rights << expense_report_read
  # professional_auditor
  professional_auditor.rights << expense_report_read

  #enterprise_owner  
  enterprise_owner.rights << expense_report_read
  # enterprise_accountant
  enterprise_accountant.rights << expense_report_read
  # enterprise_auditor
  enterprise_auditor.rights << expense_report_read

  #trial_owner  
  trial_owner.rights << expense_report_read
  # trial_accountant
  trial_accountant.rights << expense_report_read
  # trial_auditor
  trial_auditor.rights << expense_report_read

	#smb_owner  
  smb_owner.rights << expense_report_read
  # smb_accountant
  smb_accountant.rights << expense_report_read
  # smb_auditor
  smb_auditor.rights << expense_report_read

	#essential_owner  
  essential_owner.rights << expense_report_read
  # essential_accountant
  essential_accountant.rights << expense_report_read
  # essential_auditor
  essential_auditor.rights << expense_report_read

  #free_owner
  free_owner.rights << expense_report_read
end
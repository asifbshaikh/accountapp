ActiveRecord::Base.transaction do
  trail_plan = Plan.find_by_name('Trial')
  ...
  trail_owner = trail_plan.roles.find_by_name('Owner')
  smb_owner = smb_plan.roles.find_by_name('Owner')
 ...
 #product_settings_delete = Right.create!(:resource => 'product_settings', :operation => 'DELETE')
  product_settings_update = Right.create!(:resource => 'product_settings', :operation => 'UPDATE')
    ...
    #trail_owner 
    trail_owner.rights << product_settings_create
    trail_owner.rights << product_settings_read
    trail_owner.rights << product_settings_update
    #trail_owner.rights << product_settings_delete

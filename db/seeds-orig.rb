...
#ADMIN CREATION
#  admin1 = SuperUser.create(:first_name => 'Naveen', :last_name => 'Thota', :username => 'naveent', :email => 'naveen@thenextwave.in',
#                            :role => 'Admin', :active => true, :password => 'Admin@2012')
#  admin2 = SuperUser.create(:first_name => 'Harshal', :last_name => 'Katre', :username => 'harshalk', :email => 'harshal@thenextwave.in',
#                            :role => 'Admin', :active => true, :password => 'Admin@2012')
...
#    organisation_announcements_create = Right.create!(:resource => 'organisation_announcements', :operation => 'CREATE')
#    organisation_announcements_read = Right.create!(:resource => 'organisation_announcements', :operation => 'READ') 
#    organisation_announcements_delete = Right.create!(:resource => 'organisation_announcements', :operation => 'DELETE')
#    organisation_announcements_update = Right.create!(:resource => 'organisation_announcements', :operation => 'UPDATE')

   #premium_owner	
    #premium_owner.rights << organisation_announcements_create
    #premium_owner.rights << organisation_announcements_read
    #premium_owner.rights << organisation_announcements_update
    #premium_owner.rights << organisation_announcements_delete
    #premium_accountant
    #premium_accountant.rights << organisation_announcements_read
    #premium_staff
    #premium_staff.rights << organisation_announcements_read

    #enterprise_owner	
    #enterprise_owner.rights << organisation_announcements_create
    #enterprise_owner.rights << organisation_announcements_read
    #enterprise_owner.rights << organisation_announcements_update
    #enterprise_owner.rights << organisation_announcements_delete
    #enterprise_accountant
    #enterprise_accountant.rights << organisation_announcements_read
    #enterprise_staff
    #enterprise_staff.rights << organisation_announcements_read

class DebitNoteRegisterController < ApplicationController
  def index
    ...
    @ledgers = Ledger.by_voucher("DebitNote").get_record(@start_date, @end_date, @branch_id, @financial_year, @current_user, @account)
 
    prawnto :filename => "debit_note_register.pdf"
  end

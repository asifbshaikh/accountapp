class InventoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @inventory.save
        ...
        " new inventory entry for #{@inventory.account_name}", "created")
  ...
  def update
    ...
    respond_to do |format|
      if @inventory.update_attributes(params[:inventory])
         Workstream.register_user_action(@company.id, @current_user.id, request.remote_ip,
          "  inventory entry for #{@inventory.account_name}", "updated")
  ...
  def destroy
    ...
    @inventory.destroy
    Workstream.register_user_action(@company.id, @current_user.id, request.remote_ip,
     " inventory entry for #{@inventory.account_name} is marked as deleted", "deleted")
    respond_to do |format|

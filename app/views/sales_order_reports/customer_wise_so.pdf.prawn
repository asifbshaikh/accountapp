pdf = Prawn::Document.new(:page_layout => :portrait, :page => 'A4')
  pdf.bounding_box([0,pdf.cursor], :width => pdf.bounds.width, :height =>100) do
    ...
    pdf.text "<b>#{@company.label.customer_label} Wise Pending/Unexecuted Order</b>", :align => :center, :inline_format => true, :size => 12
  ...
  data = [['Date', "Sales Order", 'Product', 'Quantity','Executed', 'Unexecuted']]
  i=0
  total_quantity = 0
